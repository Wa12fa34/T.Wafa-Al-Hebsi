...
function VocabularyLevel() {
  ...
  useEffect(() => {
    async function loadVocabularyActivity() {
      setLoading(true);
      setErrorMessage("");
      setResultMessage("");
  ...
  async function saveResult(
      ...
      .insert([
        {
          ...
          /*
            Vocabulary activities do not use
            reading_passages, so passage_id stays null.
          */
          passage_id: null,
    ...
    setResultMessage(
      "Vocabulary result saved successfully ✅"
    );
  ...
  if (loading) {
    return (
      <main className="vocabulary-level-page">
        <p>Loading vocabulary activity...</p>
      </main>
    );
  }
  ...
  if (!activity) {
    return (
      <main className="vocabulary-level-page">
        <h1>Vocabulary Level {level}</h1>

        <p>
          No vocabulary activity is available
          for this level yet.
        </p>
      </main>
    );
    ...
    <main className="vocabulary-level-page">
      ...
      <section className="vocabulary-level-content">
        ...
        <div className="vocabulary-quiz-header">
          <p>Interactive Vocabulary Practice</p>
                ...
                {question.options.map((option) => {
                  ...
                  return (
                    ...
                    >
                      <input
                        type="radio"
                        name={`vocabulary-question-${index}`}
                        value={option}
                        checked={
        ...
        {score !== null && (
          <section className="score-card">
            ...
            <h3 className="performance-message">
              {percentage >= 80
                ? "🌟 Excellent Vocabulary Performance"
                : percentage >= 60
                ? "👍 Good Vocabulary Progress"
                : "📚 Keep Practising Vocabulary"}
            </h3>
